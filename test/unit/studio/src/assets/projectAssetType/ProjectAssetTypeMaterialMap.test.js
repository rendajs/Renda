 ...
 * @param {import("../../../../../../studio/src/assets/materialMapTypeSerializers/MaterialMapTypeSerializer.js").MaterialMapTypeMappableValue[]} [options.mappableValues] The list of mappable
 * values that the MapTypeSerializer should return.
 * @param {import("../../../../../../studio/src/assets/materialMapTypeSerializers/MaterialMapTypeSerializer.js").MaterialMapTypeMappableValue[]} [options.extraMappableValues] A list of extra
 * mappable values that the MapTypeSerializer should return on top of the default set of mappable values.
 * @param {import("../../../../../../studio/src/assets/MaterialMapTypeSerializerManager.js").MaterialMapAssetData} [options.readAssetDataReturnValue]
 */
function basicSetup({
	mappableValues = [
		{
...
Deno.test({
	...
	async fn() {
		...
		stub(projectAsset, "readAssetData", async () => {
			...
			/** @type {import("../../../../../../studio/src/assets/MaterialMapTypeSerializerManager.js").MaterialMapAssetData} */
			const result = {
				maps: [
					{
