...
/** @type {import("../../../../../editor/src/windowManagement/EditorWindow.js")} */
const EditorWindowMod = await importer.import("../../../../../editor/src/windowManagement/EditorWindow.js");
const {EditorWindow} = EditorWindowMod;
const onFocusedWithinChangeSym = Symbol("onFocusedWithinChange");

/** @typedef {import("../../../../../editor/src/windowManagement/EditorWindow.js").EditorWindow & {[onFocusedWithinChangeSym]: Set<(hasFocus: boolean) => void>}} EditorWindowWithSym */
...
/** @type {import("../../../../../editor/src/windowManagement/EditorWindowSplit.js")} */
const EditorWindowSplitMod = await importer.import("../../../../../editor/src/windowManagement/EditorWindowSplit.js");
const {EditorWindowSplit} = EditorWindowSplitMod;

/** @type {import("../../../../../editor/src/windowManagement/EditorWindowTabs.js")} */
...
stub(WorkspaceManager.prototype, "getCurrentWorkspace", async () => {
	/** @type {import("../../../../../editor/src/windowManagement/WorkspaceManager.js").WorkspaceData} */
	const workspaceData = {
		rootWindow: {
			type: "split",
 ...
 * @property {import("../../../../../editor/src/windowManagement/WindowManager.js").WindowManager} manager
