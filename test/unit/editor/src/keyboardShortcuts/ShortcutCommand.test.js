...
import {ShortcutCommand} from "../../../../../editor/src/keyboardShortcuts/ShortcutCommand.js";
...
function basicTest({
	...
	const mockShortcutManager = /** @type {import("../../../../../editor/src/keyboardShortcuts/KeyboardShortcutManager.js").KeyboardShortcutManager} */ ({
		getCondition(name) {
...
Deno.test({
	...
	fn() {
		 ...
		 * @param {import("../../../../../editor/src/keyboardShortcuts/ShortcutCommand.js").ShortcutCommandSequence[]} expectedSequences
		 */
